...
print("Image noise generator by Wojtekb30, 2023")
...
tryb = str(plik)[-3:].lower() #get file extension to later determine amount of color variables needed
print("File type: "+tryb)
print(" ")
...
while (x<=szerokosc and y<=wysokosc): #iterate through every pixel
    kolor = pix[x, y]
    if model==1: #proper operation and mode
        if tryb=="png":
            try:
